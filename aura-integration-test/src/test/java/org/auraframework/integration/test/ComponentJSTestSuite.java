...
public class ComponentJSTestSuite extends TestSuite {
    ...
    public static TestSuite suite() throws Exception {
        ComponentJSTestSuite suite = new ComponentJSTestSuite("*");
        TestContextManager testContextManager = new TestContextManager(ComponentJSTestSuite.class);
    ...
    public ComponentJSTestSuite(String... namespaces) {
        super();
