...
({
    ...
    testEmptyValue:{
        ...
        aura.test.assertEquals('',$A.test.getText(component.find('link').getElement()), "When value is initialized to an empty string, componenet should not have DOM elements.");
        }
    },
