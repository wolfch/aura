...
public class ShowDependenciesModelFactory implements ModelFactory<ShowDependenciesModel>{
	...
	@Override
	public ShowDependenciesModel modelInstance() throws ModelInitializationException {
		try {
			return new ShowDependenciesModel(contextService, definitionService);
