...
function iframeTest() {
    ...
    return {
        ...
        /** Creates the specified component (format is namespace:name) using $A.newCmpDeprecated. */
        createCmpDeprecatedAndWait: function(desc) {
            var iframeCmp = this.getIframeRootCmp();
            iframeCmp.set("v.load", desc);
            iframeCmp.newCmpDeprecated();
        ...
        verifyDefStorage : function(desc, present, msg) {
            ...
            $A.test.addWaitForWithFailureMessage(true,
                ...
                msg,
                function() { $A.test.assertEquals(present, iframe.defContained[desc]); });
        },
        ...
        waitForStatus: function(initialMessage, finalMessage) {
            ...
            $A.test.addWaitFor(true, function() {
                ...
                $A.test.assertEquals(finalMessage, iframeCmp.get("v.status"), iframeCmp.get("v.log"));
            });
        }
    }
}