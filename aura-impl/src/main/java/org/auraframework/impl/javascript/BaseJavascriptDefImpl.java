...
public abstract class BaseJavascriptDefImpl<T extends Definition> extends DefinitionImpl<T> implements CodeDefinition {
    ...
    public BaseJavascriptDefImpl(Builder<T> builder) {
        super(builder);
    ...
    public static abstract class Builder<T extends Definition> extends DefinitionImpl.BuilderImpl<T> implements JavascriptCodeBuilder {
		...
		public void addExpressionRef(String jsCode) {
            this.jsCode = jsCode;
        }
