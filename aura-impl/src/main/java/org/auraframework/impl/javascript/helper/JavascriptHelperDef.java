...
/**
 */
public class JavascriptHelperDef extends BaseJavascriptDefImpl<HelperDef> implements HelperDef {
    ...
    public static class Builder extends BaseJavascriptDefImpl.Builder<HelperDef> {
