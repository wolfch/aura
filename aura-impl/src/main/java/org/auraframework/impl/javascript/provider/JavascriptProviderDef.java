...
public class JavascriptProviderDef extends BaseJavascriptDefImpl<ProviderDef> implements ProviderDef {
    ...
    public static class Builder extends BaseJavascriptDefImpl.Builder<ProviderDef> {
