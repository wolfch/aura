...
public class JavascriptRendererDef extends BaseJavascriptDefImpl<RendererDef> implements RendererDef {
    ...
    public static class Builder extends BaseJavascriptDefImpl.Builder<RendererDef> {
