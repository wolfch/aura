...
public class AuraJsonContext extends ClassMapJsonSerializationContext {
    ...
    public static AuraJsonContext createContext(Mode mode, boolean refSupport, JsonSerializerFactory jsonSerializerFactory) {
        return new AuraJsonContext(mode.prettyPrint(), refSupport, jsonSerializerFactory);
    }

    private AuraJsonContext(boolean format, boolean refSupport, JsonSerializerFactory jsonSerializerFactory) {
        super(jsonSerializerFactory, format, refSupport, -1, -1);
    }
