...
public class AttributeDefHandler<P extends RootDefinition> extends ParentedTagHandler<AttributeDefImpl, P> {
    ...
    public AttributeDefHandler(ContainerTagHandler<P> parentHandler, XMLStreamReader xmlReader, Source<?> source,
        ...
        this(parentHandler, xmlReader, source, null, isInPrivilegedNamespace, definitionService, configAdapter, definitionParserAdapter);
    }

    public AttributeDefHandler(ContainerTagHandler<P> parentHandler, XMLStreamReader xmlReader, Source<?> source,
                               String defaultType, boolean isInPrivilegedNamespace, DefinitionService definitionService,
                               ConfigAdapter configAdapter, DefinitionParserAdapter definitionParserAdapter) {
