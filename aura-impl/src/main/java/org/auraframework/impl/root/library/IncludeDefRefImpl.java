...
public class IncludeDefRefImpl extends DefinitionImpl<IncludeDef> implements IncludeDefRef {
    ...
    protected IncludeDefRefImpl(Builder builder) {
        ...
        this.hashCode = AuraUtil.hashCode(imports, aliases, export, jsCode);
    }
    ...
    @Override
    public String getJsCode(boolean minify) {
        return minify ? minifiedJsCode : jsCode;
    }
    ...
    public void validateDefinition() throws QuickFixException {
        ...
        if (!jsCodeErrors.isEmpty()) {
            StringBuilder sb = new StringBuilder();
            boolean first = true;
            for (JavascriptProcessingError error : jsCodeErrors) {
            	if (first) {
            		first = false;
            	} else {
            		sb.append("\n");
