...
public class AuraBaseServletTest extends UnitTestCase {

    public AuraBaseServletTest(String name) {
        super(name);
    }
    ...
    public void testManifestCookieUpdate() {
        ...
        value = AuraBaseServlet.updateManifestCookieValue("0:0");
        checkManifestCookieValue(value, 1, 0);
        //
        // Verify that time overrides count
        //
        value = AuraBaseServlet.updateManifestCookieValue("6:0");
        checkManifestCookieValue(value, 1, 0);
        value = AuraBaseServlet.updateManifestCookieValue("");
        time = checkManifestCookieValue(value, 1, 0);
        value = AuraBaseServlet.updateManifestCookieValue(value);
